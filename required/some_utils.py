...
def create_embed(title, content, color=default_embed_color, description=discord.Embed.Empty, author=author=client.user.name, emb_type="rich", time_stamp=datetime.now(), url=discord.Embed.Empty):
