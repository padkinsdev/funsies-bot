...
def create_embed(title, content, color=default_embed_color, description=discord.Embed.Empty, author="Funsies", emb_type="rich", time_stamp=datetime.datetime.now(), url=discord.Embed.Empty):
